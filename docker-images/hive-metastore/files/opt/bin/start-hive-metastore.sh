...
test -v ADLS_ACCOUNT_NAME
test -v ADLS_TENANT_ID
test -v ADLS_CLIENT_ID
test -v ADLS_CLIENT_SECRET
...
sed -i \
  ...
  -e "s|%REGION%|${REGION:-}|g" \
  -e "s|%ADLS_ACCOUNT_NAME%|${ADLS_ACCOUNT_NAME}|g" \
  -e "s|%ADLS_TENANT_ID%|${ADLS_TENANT_ID}|g" \
  -e "s|%ADLS_CLIENT_ID%|${ADLS_CLIENT_ID}|g" \
  -e "s|%ADLS_CLIENT_SECRET%|${ADLS_CLIENT_SECRET}|g" \
